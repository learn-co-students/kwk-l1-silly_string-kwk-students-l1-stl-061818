...
your_favorite_word = "dachshund"

puts "My favorite word is #{your_favorite_word}."

# Challenge 2: Capitalize every letter in your_favorite_word using a built in Ruby method

your_favorite_word = your_favorite_word.upcase # Put a . after your_favorite word and use a String method.

puts "MY FAVORITE WORD IS #{your_favorite_word}"

# Challenge 3: Make all the letters of phrase lowercase using a built in Ruby method

phrase.swapcase = "I LOVE DACHSHUNDS"

lowercased_phrase = phrase.capitalize # Put a . after phrase and use a String method.

puts lowercased_phrase

# Challenge 4: Count how many letters are in that big_word

big_word = "deoxyribonuecleic acid"
...
sentence = sentence.gsub('o','a') # Add your gsub chain here
